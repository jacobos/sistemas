...
function currentSlide() {
	...
	var fogi = [];
	for(var i = 0; i < 3; i++)
		fogi.push(Math.floor(Math.random() * 255));
	document.body.style.backgroundColor = "rgba("+fogi[0] +"," +fogi[1] +"," +fogi[2] + ", 0.6)";
...
function createControls() {
	...
	'<div id="navLinks">' +
	'<a accesskey="t" id="toggle" href="javascript:toggle();">press "t" or click &#216;<\/a>' +
